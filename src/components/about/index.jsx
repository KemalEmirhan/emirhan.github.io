...
const About = () => {
    ...
    return (
        <article className="max-w-screen-md mx-auto flex flex-col items-baseline bg-blue-100 dark:bg-gray-800 rounded-md px-8 py-6">
            <h2 className="text-2xl font-semibold mb-6 tracking-wide m-auto text-center dark:text-white">
                Emirhan Kemal KÖSEM
            </h2>
            <p className="font-light text-center md:text-left text-black mb-4 dark:text-white">
            ...
            <span className="bg-company-blue text-white font-semibold tracking-wide p-2 rounded-md mx-auto dark:text-white">
